...
class TestFinder(TestCase):
    ...
    def test_must_found_a_complex_subject(self):
        fifi_parser = FifiParser()
        fifi_parser.feed('<html>    <body>      <div class="item">meu item 1            <div>           <a href="link-1">teste</a>          </div>      </div>      <div class="item">meu item 2            <div>               <a href="link-2">teste</a>          </div>      </div>      <div class="item">meu item 3            <div>               <a href="link-3">Alvo Existente</a>           </div>      </div>  </body></html>')
        finder = HtmlFinder(fifi_parser.document)
    ...
    def test_must_found_more_than_one_subject(self):
        fifi_parser = FifiParser()
        fifi_parser.feed('<html>    <body>      <div class="item">meu item 1            <div>           <a href="link-1">teste</a>          </div>      </div>      <div class="item">meu item 2            <div>               <a href="link-2">Alvo Existente</a>          </div>      </div>      <div class="item">meu item 3            <div>               <a href="link-3">Alvo Existente</a>           </div>      </div>  </body></html>')
        finder = HtmlFinder(fifi_parser.document)
        result = finder.find_subject('Alvo Existente')
